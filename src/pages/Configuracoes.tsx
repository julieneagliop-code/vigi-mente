...
const usuariosIniciais: Usuario[] = [
  { id: '1', nome: 'Heloisa dos Santos Martins de Oliveira Silva', email: 'heloisa@vigisuas.pv.sp.gov.br', cargo: 'Orientadora Jurídica', perfil: 'Técnico', criadoEm: '01/01/2025', ativo: true },
  { id: '2', nome: 'Andrea (Técnica de Referência)', email: 'andrea@vigisuas.pv.sp.gov.br', cargo: 'Assistente Social', perfil: 'Técnico', criadoEm: '01/01/2025', ativo: true },
  { id: '3', nome: 'Bruna (Gestora da Secretaria)', email: 'bruna@vigisuas.pv.sp.gov.br', cargo: 'Secretária de Assistência Social', perfil: 'Gestor', criadoEm: '01/01/2025', ativo: true },
];
...
export default function Configuracoes() {
  ...
  const handleSave = () => {
    ...
    if (editingId) {
      ...
      toast({ title: 'Usuário criado com sucesso!', description: 'Senha temporária: VigiSUAS2025' });
    }
    setDialogOpen(false);
  };
